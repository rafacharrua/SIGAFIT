...
ЁFun┤└o    ЁU_Modelo3     ЁAutor ЁMarinaldo de Jesus   Ё Data Ё19/05/2006Ё
цддддддддддеддддддддддддддаддддддадддддддддддддддддддддаддддддадддддддддд╢
ЁDescri┤└o ЁEnchoice e GetDados											 Ё
...
EndIF
	...
	oEnchoice 		:= MsMGet():New(;
										...
										lVirtual		,;	//16 ->	lMemoria	-> Se os Dados sЦo de Memoria ( DEFAULT ) ou Arquivo
